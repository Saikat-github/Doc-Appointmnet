...
const TopDoctors = () => {
    ...
    return (
        <div id='top-doctors' className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
            ...
            <button onClick={() => navigate("/doctors")} className='bg-blue-100 text-gray-600 px-12 py-3 rounded-full mt-10 hover:bg-blue-200 transition-all duration-300'>More</button>
        </div>
    )
}
