...
const appointmentCancel = async (req, res) => {
    try {
        ...
        if (appointmentData && appointmentData.docId === docId) {
            ...
            let { slotDate, slotTime } = appointmentData;
...
const updateDoctorProfile = async (req, res) => {
    try {
        const {docId, fees, address, available, name} = req.body;
...
export { changeAvailability, doctorsList, doctorLogin, appointmentsDoctor, appointmentComplete, appointmentCancel, doctorDashboard, doctorProfile, updateDoctorProfile };